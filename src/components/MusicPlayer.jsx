...
function MusicPlayer() {
    return (
        <div className="MusicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
            ...
            <div className="upperPart flex items-center justify-between">
                <div className="profile flex">
                    ...
                    <div className="details flex flex-col ml-4">
                        ...
                        <span className='text-sm text-gray-500'>Unkown Artist</span>
                    </div>
                </div>
                <div>
            ...
            {/* LowerPart */}
            <div className="lowerPart flex-col items-center justify-between mt-5">
                {/* track */}
                ...
                {/* Controls Part */}
                <div className="controls flex-1 flex items-center justify-around mt-5">
                    {/* previous arrow */}
